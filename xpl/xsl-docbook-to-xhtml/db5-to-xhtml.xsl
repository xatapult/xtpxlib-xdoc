...
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:local="#local"
  ...
  <xsl:variable name="create-header" as="xs:boolean" select="xs:boolean($create-header)"/>
  <xsl:variable name="add-roles-as-classes" as="xs:boolean" select="xs:boolean($add-roles-as-classes)"/>
